...
python main.py  --n_classes 10 --epochs 5 --dropout 0.6 --activation relu --denselayer_size 1024 --batch_size 32 --train_model True --model_version InceptionResNetV2 --l_rate 0.001 --optimizer Adam --loss categorical_crossentropy
