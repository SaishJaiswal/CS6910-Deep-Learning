...
from tensorflow.keras.layers import Dense, Embedding, LSTM, SimpleRNN, GRU, Concatenate, TimeDistributed, CuDNNLSTM, CuDNNGRU
...
def BuildModelAttention(Cell_Type, n_enc_dec_layers, hidden_layer_size, num_encoder_tokens, num_decoder_tokens, dropout, emb_size):
	...
	if Cell_Type == 'RNN':
		if n_enc_dec_layers == 1:	
			encoder_outputs1, h1 = SimpleRNN(hidden_layer_size, return_state=True, return_sequences=True, name="enc_layer1")(enc_emb)
			encoder_states = [h1]
		elif n_enc_dec_layers == 2:
			encoder_outputs1, h1 = SimpleRNN(hidden_layer_size, return_state=True, return_sequences=True, name="enc_layer1")(enc_emb)
			encoder_outputs2, h2 = SimpleRNN(hidden_layer_size, return_state=True, return_sequences=True, name="enc_layer2")(encoder_outputs1)
			encoder_states = [h1, h2]
		elif n_enc_dec_layers == 3:
			encoder_outputs1, h1 = SimpleRNN(hidden_layer_size, return_state=True, return_sequences=True, name="enc_layer1")(enc_emb)
			encoder_outputs2, h2 = SimpleRNN(hidden_layer_size, return_state=True, return_sequences=True, name="enc_layer2")(encoder_outputs1)
			encoder_outputs3, h3 = SimpleRNN(hidden_layer_size, return_state=True, return_sequences=True, name="enc_layer3")(encoder_outputs2)
			encoder_states = [h1, h2, h3]

	elif Cell_Type == 'LSTM':
		if n_enc_dec_layers == 1:
			encoder_outputs1, h1, c1 = CuDNNLSTM(hidden_layer_size, return_state=True, return_sequences=True, name="enc_layer1")(enc_emb)
			encoder_states = [h1, c1]
		elif n_enc_dec_layers == 2:
			encoder_outputs1, h1, c1 = CuDNNLSTM(hidden_layer_size, return_state=True, return_sequences=True, name="enc_layer1") (enc_emb)
			encoder_outputs2, h2, c2 = CuDNNLSTM(hidden_layer_size, return_state=True, return_sequences=True, name="enc_layer2")(encoder_outputs1)
			encoder_states = [h1, c1, h2, c2]
		elif n_enc_dec_layers == 3:
			encoder_outputs1, h1, c1 = CuDNNLSTM(hidden_layer_size, return_state=True, return_sequences=True, name="enc_layer1")(enc_emb)
			encoder_outputs2, h2, c2 = CuDNNLSTM(hidden_layer_size, return_state=True, return_sequences=True, name="enc_layer2")(encoder_outputs1)
			encoder_outputs3, h3, c3 = CuDNNLSTM(hidden_layer_size, return_state=True, return_sequences=True, name="enc_layer3")(encoder_outputs2)
			encoder_states = [h1, c1, h2, c2, h3, c3]
	elif Cell_Type == 'GRU':
		if n_enc_dec_layers == 1:
			encoder_outputs1, h1 = CuDNNGRU(hidden_layer_size, return_state=True, return_sequences=True, name="enc_layer1")(enc_emb)
			encoder_states = [h1]
		elif n_enc_dec_layers == 2:
			encoder_outputs1, h1 = CuDNNGRU(hidden_layer_size, return_state=True, return_sequences=True, name="enc_layer1")(enc_emb)
			encoder_outputs2, h2 = CuDNNGRU(hidden_layer_size, return_state=True, return_sequences=True, name="enc_layer2")(encoder_outputs1)
			encoder_states = [h1, h2]
		elif n_enc_dec_layers == 3:
			encoder_outputs1, h1 = CuDNNGRU(hidden_layer_size, return_state=True, return_sequences=True, name="enc_layer1")(enc_emb)
			encoder_outputs2, h2 = CuDNNGRU(hidden_layer_size, return_state=True, return_sequences=True, name="enc_layer2")(encoder_outputs1)
			encoder_outputs3, h3 = CuDNNGRU(hidden_layer_size, return_state=True, return_sequences=True, name="enc_layer3")(encoder_outputs2)
			encoder_states = [h1, h2, h3]
	...
	if Cell_Type == 'RNN':
		...
		if n_enc_dec_layers == 1:
			decoder_outputs1, dh1, dc1 = CuDNNLSTM(hidden_layer_size, return_sequences=True, return_state=True, name="dec_layer1")(dec_emb, initial_state=[h1, c1])
		elif n_enc_dec_layers == 2:
			decoder_outputs1, dh1, dc1 = CuDNNLSTM(hidden_layer_size, return_sequences=True, return_state=True, name="dec_layer1")(dec_emb, initial_state=[h1, c1])
			decoder_outputs2, dh2, dc2 = CuDNNLSTM(hidden_layer_size, return_sequences=True, return_state=True, name="dec_layer2")(decoder_outputs1, initial_state=[h2, c2])
		elif n_enc_dec_layers == 3:
			decoder_outputs1, dh1, dc1 = CuDNNLSTM(hidden_layer_size, return_sequences=True, return_state=True, name="dec_layer1")(dec_emb, initial_state=[h1, c1])
			decoder_outputs2, dh2, dc2 = CuDNNLSTM(hidden_layer_size, return_sequences=True, return_state=True, name="dec_layer2")(decoder_outputs1, initial_state=[h2, c2])
			decoder_outputs3, dh3, dc3 = CuDNNLSTM(hidden_layer_size, return_sequences=True, return_state=True, name="dec_layer3")(decoder_outputs2, initial_state=[h3, c3])
	elif Cell_Type == 'GRU':
		if n_enc_dec_layers == 1:
			decoder_outputs1, dh1 = CuDNNGRU(hidden_layer_size, return_sequences=True, return_state=True, name="dec_layer1")(dec_emb, initial_state=[h1])
		elif n_enc_dec_layers == 2:
			decoder_outputs1, dh1 = CuDNNGRU(hidden_layer_size, return_sequences=True, return_state=True, name="dec_layer1")(dec_emb, initial_state=[h1])
			decoder_outputs2, dh2 = CuDNNGRU(hidden_layer_size, return_sequences=True, return_state=True, name="dec_layer2")(decoder_outputs1, initial_state=[h2])
		elif n_enc_dec_layers == 3:
			decoder_outputs1, dh1 = CuDNNGRU(hidden_layer_size, return_sequences=True, return_state=True, name="dec_layer1")(dec_emb, initial_state=[h1])
			decoder_outputs2, dh2 = CuDNNGRU(hidden_layer_size, return_sequences=True, return_state=True, name="dec_layer2")(decoder_outputs1, initial_state=[h2])
			decoder_outputs3, dh3 = CuDNNGRU(hidden_layer_size, return_sequences=True, return_state=True, name="dec_layer3")(decoder_outputs2, initial_state=[h3])
